...
(custom-set-variables
 ...
 '(package-selected-packages
   '(meow avy cape cargo catppuccin-theme cmake-mode corfu-terminal devdocs diminish dts-mode eat eglot-booster embark-consult evil-collection evil-commentary evil-surround fancy-compilation forge general grip-mode hl-todo json-mode just-mode kind-icon ligature marginalia nerd-icons orderless persp-projectile perspective projectile protobuf-mode pyvenv rainbow-delimiters rainbow-mode ripgrep rust-mode solaire-mode undo-fu vertico wgrep yaml-mode))
